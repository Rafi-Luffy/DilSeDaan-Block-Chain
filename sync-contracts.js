...
const CONTRACT_CONFIG = {
  ...
  DONATION_CONTRACT_ADDRESS: process.env.POLYGON_DONATION_CONTRACT || "",
  MILESTONE_CONTRACT_ADDRESS: process.env.POLYGON_MILESTONE_CONTRACT || "",
  AUDIT_CONTRACT_ADDRESS: process.env.POLYGON_AUDIT_CONTRACT || "",
