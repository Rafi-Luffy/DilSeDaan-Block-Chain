...
export const useWeb3Store = create<Web3State>()(
  persist(
    (set, get) => ({
      ...
      networkError: null,
      donationContractAddress: "0x68B1D87F95878fE05B998F19b66F4baba5De1aed",
      milestoneContractAddress: "0x3Aa5ebB10DC797CAC828524e59A333d0A371443c",
      auditContractAddress: "0xc6e7DF5E7b4f2A278906862b61205850344D4e7d",
      pendingTransactions: [],
