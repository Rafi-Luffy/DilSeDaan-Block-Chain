...
// Service imports (initialize services)
import './services/recurringDonationService'; // This will start the cron scheduler
...
const initializeBlockchain = () => {
  try {
    ...
    contract = new ethers.Contract(
      process.env.DONATION_CONTRACT_ADDRESS || '0x0000000000000000000000000000000000000000',
      contractABI,
      provider
    );
