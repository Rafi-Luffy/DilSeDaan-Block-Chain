...
export function FunctionalAdminDashboard({ className }: AdminDashboardProps) {
  ...
  const handleApproveUser = async (userId: string) => {
    ...
    try {
      ...
      toast({
        ...
        description: "User KYC status updated to verified (using mock data)",
      })
  ...
  const handleRejectUser = async (userId: string) => {
    ...
    try {
      ...
      toast({
        ...
        description: "User KYC status updated to rejected (using mock data)",
      })
      setUsers(prev => prev.map(user => 
  ...
  const handleDeleteUser = async (userId: string) => {
    ...
    try {
      ...
      toast({
        ...
        description: "User has been successfully removed (using mock data)",
      })
  ...
  const handleExportData = async (type: string) => {
    ...
    try {
      ...
      toast({
        title: "Export Completed (Mock)",
        description: `${type} data exported successfully (mock data)`,
      })
      // Mock export
      const csvContent = `data:text/csv;charset=utf-8,${type},Mock Data\nExample,123\n`
      ...
      {activeTab === 'overview' && (
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-warm-cream">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-warm-charcoal">Blockchain Metrics</h3>
                <Button variant="ghost" size="sm" onClick={handleSystemHealth}>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 rounded-xl bg-warm-purple/5">
                  ...
                  <span className="font-semibold">{stats.blockchainTransactions}</span>
                </div>
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              ...
              <Button onClick={handleCreateCampaign} className="bg-warm-orange hover:bg-warm-orange-dark text-white">
            ...
            {campaigns.map((campaign) => (
              <div key={campaign.id} className="bg-white rounded-2xl p-6 shadow-lg border border-warm-cream">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    <p className="text-sm text-warm-charcoal-light">Raised</p>
                    <p className="text-lg font-semibold text-warm-green">
                      ₹{campaign.raised.toLocaleString()}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-warm-charcoal-light">Target</p>
                    <p className="text-lg font-semibold text-warm-charcoal">
                      ₹{campaign.target.toLocaleString()}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-warm-charcoal-light">Donors</p>
                ...
                <div className="flex space-x-3">
                  <Button 
                    className="flex-1 border border-warm-orange text-warm-orange hover:bg-warm-orange hover:text-white"
                  ...
                  <Button 
                    className="flex-1 bg-warm-orange hover:bg-warm-orange-dark text-white"
              ...
              {users.map((user) => (
                <div key={user.id} className="flex items-center justify-between p-4 rounded-xl bg-warm-cream/30">
                  <div className="flex items-center space-x-4">
                    <div className="w-10 h-10 rounded-full bg-warm-blue/10 flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        <span className="text-xs px-2 py-1 rounded bg-warm-blue/10 text-warm-blue">
                          {user.role}
                        </span>
                        <span className={cn(
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              ...
              <Button
                onClick={() => handleExportData('blockchain')}
                variant="outline"
                disabled={loading}
              >
                <Download className="h-4 w-4 mr-2" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-warm-cream">
              <h4 className="text-lg font-semibold text-warm-charcoal mb-4">Smart Contracts</h4>
                ...
                {[
                  ...
                  <div key={contract.name} className="flex items-center justify-between p-3 rounded-xl bg-warm-cream/30">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-warm-green">{contract.status}</span>
      ...
      {loading && (
        <div className="fixed inset-0 bg-black/20 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 shadow-xl">
            <div className="flex items-center space-x-3">
              <div className="animate-spin rounded-full h-6 w-6 border-2 border-warm-orange border-t-transparent"></div>
              <span className="text-warm-charcoal">Processing...</span>
            </div>
          </div>
        </div>
      )}
